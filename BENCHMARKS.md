# Stoolap v0.3.4 Benchmark Results
...
*Benchmarks performed on Apple Silicon, in-memory mode, best of 10 runs. Results are point-in-time for v0.3.4; re-run on your hardware and workload for current numbers.*
