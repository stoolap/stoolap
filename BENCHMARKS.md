# Stoolap v0.3.7 Benchmark Results
...
*Benchmarks performed on Apple Silicon, in-memory mode, best of 10 runs. Results are point-in-time for v0.3.7; re-run on your hardware and workload for current numbers.*
